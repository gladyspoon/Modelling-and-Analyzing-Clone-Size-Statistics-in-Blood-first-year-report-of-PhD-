...
Divide_develop<- function(clone_info, dt, B0, D0,r,mean_fitness,t){
  
  cloneID=clone_info[[1]] # [[ID1, s1],[ID2,s2]...] is the ID of the clone
  clone_size=clone_info[[2]] # n
  ...
  new_clone_size = exp(r*t*dt)
  #new_clone_size = 100000   constant feeding check
...
#     print('clone_size =',clone_size)
      ...
      for (i in 1:length(cloneID) )
        {Total_fitness_effects=Total_fitness_effects+cloneID[[i]][[2]]}
      #fitness of the clone is the sum of fitness conferred by all mutations it contains
      Total_fitness_effects=Total_fitness_effects                                     
...
alpha=0.1;
benefit=alpha*r; #is the fitness of the first mutant i.e. r-s_del
...
B0=1;
D0=1;
u=10^-6;                        #deleterious mutation rate 
...
#divide: propagate growth of each clone
          ...
          #feeding clone
          Bio_system[[1]][[2]]=Divide_develop(Bio_system[[1]], dt, B0, D0,r,mean_fitness,t)[[1]]   #update feeding clone size
...
# write.csv(unlist(Total_mutation_frequency_single_deleterious_2), file= "alpha_minus0.5_10000ppl_Age60_u_10minus6.csv")
# write.csv(unlist(Total_mutation_frequency_single_deleterious_4), file= "alpha_minus0.5_10000ppl_Age90_u_10minus6.csv")
# write.csv(unlist(Total_mutation_frequency_single_deleterious_6), file= "alpha_minus0.5_10000ppl_Age110_u_10minus6.csv")
######################################################################################################################
